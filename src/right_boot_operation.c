...
void right_boot_operation(bool *requestFinished, bool *UARTTransmit, bool *UARTSendEnable, 
    ...
    // You can add your actual code logic here
}
...
//         if (err < 0) {
//             printk("Could not read ADC data (%d)", err);
//         }
//     }
...
//                 }
//             } else {
//                 printk("Failed to lock UART data mutex");
//             }
//         }
...
//             if (err < 0) {
//                 printk("Failed to transmit over Bluetooth (%d)", err);
//             }
//         }
