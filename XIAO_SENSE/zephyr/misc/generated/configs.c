...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_U_BLOX_M10_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 10000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCAN_SHORT_NAME_MAX_LEN, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCAN_SHORT_NAME_CNT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_U_BLOX_PROTOCOL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL_ERR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_U_BLOX_M10, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_GYRO_ODR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_ACCEL_FS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_ACCEL_ODR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_WIDE_DATA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_UBX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_UBX_LOG_BUFFER, 128);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_BACKEND_UART_ASYNC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_BACKEND_UART_ISR_RECEIVE_IDLE_TIMEOUT_MS, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_BACKEND_UART_ASYNC_TRANSMIT_TIMEOUT_MS, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_BACKEND_UART_ASYNC_RECEIVE_IDLE_TIMEOUT_MS, 30);
