...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL_WRN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_LOG_LEVEL_WRN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_LOG_LEVEL, 2);
