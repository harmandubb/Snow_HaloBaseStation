...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MGMT_SUITFU_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_DUMP_TO_LOG_BUF_SIZE, 128);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HWINFO_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DRIVER_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_ENV_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_LOG_LEVEL, 4);
